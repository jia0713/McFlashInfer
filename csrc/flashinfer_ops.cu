...
//                                  at::Tensor o, std::optional<at::Tensor> maybe_lse, int64_t
...
// void apply_rope(at::Tensor q, at::Tensor k, at::Tensor q_rope, at::Tensor k_rope, at::Tensor
// indptr,
...
//                         at::Tensor indptr, at::Tensor offsets, int64_t rotary_dim, bool
//                         interleave, double rope_scale, double rope_theta, double low_freq_factor,
...
//                         at::Tensor pos_ids, int64_t rotary_dim, bool interleave, double
...
void sampling_from_probs(at::Tensor probs, at::Tensor uniform_samples, at::Tensor samples,
                         bool deterministic, int64_t cu_stream);
...
void top_p_sampling_from_probs(at::Tensor probs, at::Tensor uniform_samples, at::Tensor samples,
                               ...
                               double top_p_val, bool deterministic, int64_t cu_stream);
...
void top_k_sampling_from_probs(at::Tensor probs, at::Tensor uniform_samples, at::Tensor samples,
                               ...
                               int64_t top_k_val, bool deterministic, int64_t cu_stream);
