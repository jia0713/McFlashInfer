  ...
  DISPATCH_context(
      DTypeQ, DTypeKV, DTypeO, IdType, MASK_MODE, HEAD_DIM_CKV, HEAD_DIM_KPE, Params, [&] {
        DISPATCH_MLA_CTA_TILE_Q(plan_info.cta_tile_q, CTA_TILE_Q, {
          ...
          params.kv_indptr =
              GetPtrFromBaseOffset<IdType>(int_buffer_ptr, plan_info.kv_indptr_offset);
          ...
          params.merge_packed_offset_end = GetPtrFromBaseOffset<IdType>(
              int_buffer_ptr, plan_info.merge_packed_offset_end_offset);
          ...
          cudaError_t status =
              mla::BatchMLAPagedAttention<MASK_MODE, HEAD_DIM_CKV, HEAD_DIM_KPE, CTA_TILE_Q>(
